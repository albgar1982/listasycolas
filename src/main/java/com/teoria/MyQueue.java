...
public class MyQueue {
  ...
  public int remove() {
    ...
    int firstValue = first.value; //Guardamos el valor del first, que es lo que vamos a devolver al final
    ...
    if (first == null) { //Si first es null tras esa asignación anterior (No había first.next)
